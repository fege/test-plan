...
description: Generate test function code from TC specification matching repository conventions. Use for creating individual pytest test functions from test case specifications with proper fixtures, imports, and assertions.
context: fork
allowedTools: Read
model: opus
